...
ActiveRecord::Schema[8.0].define(version: 2024_12_02_102219) do
  ...
  create_table "affiliated_groups", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "group_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group_id"], name: "index_affiliated_groups_on_group_id"
    t.index ["user_id", "group_id"], name: "index_affiliated_groups_on_user_id_and_group_id", unique: true
